...
export default function <CP>(
  ...
  return <P extends CP>(WrappedComponent: React.ComponentClass<P>) => {
    ...
    const InjectContext: React.FC<WrappedComponentPropsWithForwardRef> = (
      props,
    ) => {
    ...
    return React.forwardRef<WrappedComponentInstance, WrappedComponentProps>(
      (props, ref) => <InjectContext forwardRef={ref} {...(props as any)} />,
    );
  };
}
